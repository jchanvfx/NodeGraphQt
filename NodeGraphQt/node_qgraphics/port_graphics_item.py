...
class PortGraphicsItem(QtWidgets.QGraphicsItem):
    """
    The base QGraphics item with Port logic.
    """
...
class CustomPortGraphicsItem(PortGraphicsItem):
    """
    Custom Port QGraphics item for drawing custom shape port.
    """
